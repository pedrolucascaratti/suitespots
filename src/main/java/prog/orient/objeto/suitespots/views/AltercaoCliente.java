...
public class AltercaoCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSalvar.setFont(new java.awt.Font("Segoe UI", 0, 22)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltercaoCliente.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
